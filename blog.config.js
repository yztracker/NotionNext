...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YTZ', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個全端工程師，對於最新科技技術充滿熱情', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-orcin-sigma.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, BLOG, AI, ChatGPT, Frontend, Backend', // 网站关键词 英文逗号隔开
